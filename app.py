...
# Load dataset to extract unique brands
...
st.write("Enter the details of the car to estimate its price.")
...
if st.button("Estimate Price"):
    ...
    st.success(f"💰 Estimated Car Price: ₹{estimated_price:.2f} Lakhs")
